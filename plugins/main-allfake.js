...
global.namechannel = '♡ -💉 ׅ ᩡ ׂ 𝗦𝕙i𝐧𝒐𝚋𝑢 𝕂𝒐𝐜𝚑𝗈 ׂ ᠀ 𑅆  ! ˖ -  ❀'
global.namechannel2 = '♡ -💉 ׅ ᩡ ׂ 𝗦𝕙i𝐧𝒐𝚋𝑢 𝕂𝒐𝐜𝚑𝗈 ׂ ᠀ 𑅆  ! ˖ '
global.namegrupo = '.•♫•♬• ♡ -💉 ׅ ᩡ ׂ 𝗦𝕙i𝐧𝒐𝚋𝑢 𝕂𝒐𝐜𝚑𝗈 ׂ ᠀ 𑅆  ! ˖ - 𝐁  •♬•♫•.'
global.namecomu = '✿:･✧ ᩡ ׂ 𝗦𝕙i𝐧𝒐𝚋𝑢 𝕂𝒐𝐜𝚑𝗈 ׂ ᠀ 𑅆  ˖   ✧･:✿'
...
global.rcanaimport pkg from '@whiskeysockets/baileys'
import fs from 'fs'
import fetch from 'node-fetch'
import axios from 'axios'
import moment from 'moment-timezone'
...
l = { contextInfo: { isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, serverMessageId: 100, newsletterName: channelRD.name, }, externalAdReply: { showAdAttribution: true, title: packname, body: dev, mediaUrl: null, description: null, previewType: "PHOTO", thumbnailUrl: icono, sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false }, }, }}
